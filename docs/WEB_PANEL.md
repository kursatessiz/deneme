...
göre menü, tema), W2.2 kapsamında eklenen takvim, üye kartı, paket satışı
ve yoklama ekranlarını (aşağıda "Takvim, üye kartı, paket satışı, yoklama
(W2.2)") ve W2.4 kapsamında eklenen finans ve rapor ekranlarını (aşağıda
"Finans, hakediş, raporlar, adaylar, riskli üyeler (W2.4)") anlatır. Rol/yetki
ve tema seçim ekranı (2.3) ayrı bir işten gelir.
