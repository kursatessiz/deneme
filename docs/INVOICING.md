...
Fatura numarası, fatura kaydı oluşturulurken işletme, seri ve yıl bazında atomik olarak ayrılır. Sağlayıcıya gönderim başarısız olursa kayıt FAILED durumunda numarasını korur ve yeniden denemede aynı numarayla gönderilir; bu nedenle numara boşluğu oluşmaz. Gerçek entegratörlerin çoğu numarayı kendisi verdiği için entegrasyon yapılırken sağlayıcının döndürdüğü numara `providerUuid` ile birlikte saklanmalı ve belge üzerinde o numara kullanılmalıdır; bu karar entegratör seçilince netleştirilecektir.
