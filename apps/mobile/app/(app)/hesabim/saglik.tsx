  ...
  return (
    <ScreenContainer>
      <Text style={[styles.lead, { color: colors.textSecondary }]}>
        Apple Health veya Health Connect ile katıldığınız dersleri ve isterseniz günlük adım, aktif enerji ve dinlenme
      ...
      <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        <Text style={[styles.cardTitle, { color: colors.textPrimary }]}>Derslerimi sağlığa yaz</Text>
        <Text style={[styles.cardDescription, { color: colors.textSecondary }]}>
          Katıldığınız bir ders bittiğinde, ders türü ve süresi (girdiyseniz kalori) cihazınızın sağlık uygulamasına
          antrenman olarak yazılır. Aynı ders asla iki kez yazılmaz.
        </Text>
