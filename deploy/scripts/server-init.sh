#!/usr/bin/env bash
# ==============================================================================
# Pilates Studio OS - Ubuntu 24.04 Production Server Bootstrap Script
...
echo "======================================================================"
echo "🚀 Starting Ubuntu 24.04 LTS Server Bootstrap for Pilates Studio OS"
echo "======================================================================"
...
echo "📁 Setting up deployment folders at /opt/pilates-studio..."
mkdir -p /opt/pilates-studio/caddy
mkdir -p /opt/pilates-studio/backups
mkdir -p /opt/pilates-studio/scripts
...
echo "   - Docker: Active"
echo "   - App Dir: /opt/pilates-studio"
echo "======================================================================"
